...
\section{Cambios transcripcionales en respuesta a estrés abiotico en A.thaliana}\label{sec:wiegel}
...
\subsection{PINs AI1 y LCI binaria}
...
\begin{center}
    ...
    \captionof{figure}{Mapa KEGG de la vía metabólica de Arabidopsis Thaliana  ``\textit{Synthesis and degradation of ketone bodies}'' de metabolismo lipídico. (fuente: KEGG PATHWAY)}
    \label{fig:mapa_kegg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.8\textwidth]{ejemplo_de_go}
    \captionof{figure}{Subgrafo de la ontología BP de GO mostrando el proceso biológico ``Positive regulation of cellular component organization''.}
...
\begin{center}
    ...
    \captionof{figure}{Los distintos tipos de código de evidencia en cada una de las ontologías (BP en negro, MF en gris oscuro y CC en gris claro) y la fracción del total que representan.}
