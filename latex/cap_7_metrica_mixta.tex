...
\captionof{figure}{En la primer segunda y tercer columna mostramos los resultados del analisis para clusters transcripcionales 2, 6 y 13 del tratamiento Frio respectivamente.La primer, 2da y 3era fila...dtc,cnm, infomp
Circulo cluster origianl.Cuadraditos son subgrupos. Nivel de grisado depende de alejamiento de curvas de control. Las curvas punteadas son 1sigma, 2sigma y 3sigma...etc el grisado de los c.}
...
Cabe notar que en este caso, se trata de conjuntos muy chicos de genes, por lo que es de esperar una mayor divergencia entre la estimación de congruencia biológica dada a partir de significancia de test de sobrerepresentacion y la asociada al índice BHI (que solo exige coincidencia en un grupo, sin importar su especificad).\\
