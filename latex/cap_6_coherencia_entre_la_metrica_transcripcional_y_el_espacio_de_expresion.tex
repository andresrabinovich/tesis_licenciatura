...
\begin{center}
\includegraphics[width=0.8\textwidth]{erdos_renyi_vs_30kmnn.pdf}
\captionof{figure}{Distribución de grado para los nodos de la red $30kmnn$ para el tratamiento 'Frío' y para una red de Erdös-Rény con idéntica cantidad de nodos y aristas.}
...
\captionof{figure}{Distribución de betweenness centrality en función del grado de la red para los nodos de las redes $30kmnn$ para el tratamiento 'Frío', Erdös-Rényi y configuracional.}
