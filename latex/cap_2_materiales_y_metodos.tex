...
\section{Cambios transcripcionales en respuesta a estrés abiotico en \textit{A.thaliana}}
\label{sec:wiegel}
...
\begin{center}
    ...
    \captionof{figure}{Mapa KEGG de la vía metabólica de \textit{Arabidopsis thaliana}  ``\textit{Synthesis and degradation of ketone bodies}'' de metabolismo lipídico. (fuente: KEGG PATHWAY)}
    \label{fig:mapa_kegg}
\end{center}
